...
export default function TempCard({details}){
  ...
  <Card className ='temp-card-main'>
    <Card.Content>
      <Card.Header className='temp-card-child'>{details.name} <img
          ...
          <Feed.Content>
            ...
            <div className = 'temp-card'>
              <div className = 'temp-card-child'>
                ...
                <div className = 'temp-card'>
              <div className = 'temp-card-child'>
              <b>Sunrise</b>: {new Date(details.sys.sunrise *1000).toLocaleTimeString('en-IN')}
                </div>
                <div className = 'temp-card-child'>
                <b>Sunset</b>: {new Date(details.sys.sunset *1000).toLocaleTimeString('en-IN')}
                </div>
                </div>
          </Feed.Content>
        </Feed.Event>
